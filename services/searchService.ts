...
const LOCATION_ALIASES: Record<string, string[]> = {
    ...
    'muhammadpur': ['mohammadpur', 'shia_masjid', 'ring_road'],
    'muhammad pur': ['mohammadpur', 'shia_masjid', 'ring_road'],
    'mohammadpour': ['mohammadpur', 'shia_masjid', 'ring_road'],
    'mohammodpur': ['mohammadpur', 'shia_masjid', 'ring_road'],
