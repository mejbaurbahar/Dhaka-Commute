...
export const Icon = {
  ...
  plane: ({ s = 18 }: IconProps) =>
    svg(
      <path d="M17.8 19.2L16 11l3.5-3.5a2.12 2.12 0 010-3 2.12 2.12 0 013 0L23 8a2.12 2.12 0 010 3L19.5 14.5l-8.2 1.8a2 2 0 00-1.6.9L7 21l-3 1 1-3 4.8-1.8a2 2 0 00.9-1.6L13 7.5" />,
      s,
    ),
  ...
  boat: ({ s = 18 }: IconProps) =>
    svg(
      <>
        <path d="M2 20a2.4 2.4 0 002 1 2.4 2.4 0 002-1 2.4 2.4 0 012-1 2.4 2.4 0 012 1 2.4 2.4 0 002 1 2.4 2.4 0 002-1 2.4 2.4 0 012-1 2.4 2.4 0 012 1 2.4 2.4 0 002 1" />
        <path d="M4 18l2-6 12-6 2 6" />
        <path d="M4 18h16" />
  ...
  truck: ({ s = 18 }: IconProps) =>
    svg(
      <>
        <path d="M1 6h11v9H1z" />
        <path d="M12 9h4l3 3v3h-7" />
