...
const MRT6: Line = {
  ...
  stations: [
    ...
    { id: 'u6-bs',  name: 'Bijoy Sarani',       bn: 'বিজয় সরণি',          lat: 23.7664, lng: 90.3763, status: 'active' },
    { id: 'u6-fg',  name: 'Farmgate',           bn: 'ফার্মগেট',            lat: 23.7602, lng: 90.3865, status: 'active' },
...
const MRT1: Line = {
  ...
  stations: [
    ...
    { id: 'u1-nd',  name: 'Nadda',               bn: 'নদ্দা',                    lat: 23.8200, lng: 90.4290, status: 'under-construction' },
    { id: 'u1-nb',  name: 'Notun Bazar',         bn: 'নতুন বাজার',               lat: 23.7978186, lng: 90.4236046, status: 'under-construction' },
    { id: 'u1-nbd', name: 'North Badda',         bn: 'উত্তর বাড্ডা',             lat: 23.7900, lng: 90.4340, status: 'under-construction' },
    ...
    { id: 'u1-rp',  name: 'Rampura',             bn: 'রামপুরা',                  lat: 23.7560, lng: 90.4230, status: 'under-construction' },
    { id: 'u1-ml',  name: 'Malibagh',            bn: 'মালিবাগ',                  lat: 23.7460, lng: 90.4170, status: 'under-construction' },
    { id: 'u1-rb',  name: 'Rajarbagh',           bn: 'রাজারবাগ',                 lat: 23.7370, lng: 90.4200, status: 'under-construction' },
  ...
  branches: [[
    ...
    { id: 'u1-nd2', name: 'Nadda',               bn: 'নদ্দা',                    lat: 23.8200, lng: 90.4290, status: 'under-construction' },
    { id: 'u1-js',  name: 'Joar Sahara',         bn: 'জোয়ার সাহারা',             lat: 23.8100, lng: 90.4560, status: 'under-construction' },
    { id: 'u1-bo',  name: 'Boalia',              bn: 'বোয়ালিয়া',                lat: 23.8050, lng: 90.4700, status: 'under-construction' },
    { id: 'u1-ms',  name: 'Mastul',              bn: 'মস্তুল',                   lat: 23.8000, lng: 90.4850, status: 'under-construction' },
    { id: 'u1-cs',  name: 'Purbachal Cricket Stadium', bn: 'পূর্বাচল ক্রিকেট স্টেডিয়াম', lat: 23.8070, lng: 90.4980, status: 'under-construction' },
    { id: 'u1-pc',  name: 'Purbachal Centre',    bn: 'পূর্বাচল মধ্য',            lat: 23.8060, lng: 90.5150, status: 'under-construction' },
    { id: 'u1-pe',  name: 'Purbachal East',      bn: 'পূর্বাচল পূর্ব',           lat: 23.8050, lng: 90.5300, status: 'under-construction' },
...
const MRT5S: Line = {
  ...
  stations: [
    ...
    { id: 'u5s-cg', name: 'College Gate',     bn: 'কলেজ গেট',          lat: 23.7660, lng: 90.3750, status: 'planned' },
...
const MRT2: Line = {
  ...
  stations: [
    ...
    { id: 'u2-nm',  name: 'New Market',   bn: 'নিউ মার্কেট',  lat: 23.7350, lng: 90.3860, status: 'planned' },
...
const MRT4: Line = {
  ...
  stations: [
    ...
    { id: 'u4-cr', name: 'Chittagong Road',bn: 'চট্টগ্রাম রোড',   lat: 23.6800, lng: 90.4690, status: 'planned' },
