  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      bullets: [
        ...
        lbl('Logo, brand name "KoyJabo / কই যাবো", visual identity: trademarks of Mejbaur Bahar Fagun, protected under the Trademark Act, 2009 (registration pending/intended).', 'লোগো, ব্র্যান্ড নাম "KoyJabo / কই যাবো", ভিজ্যুয়াল আইডেন্টিটি: Mejbaur Bahar Fagun-এর ট্রেডমার্ক, ট্রেডমার্ক আইন ২০০৯-এর অধীনে সুরক্ষিত (রেজিস্ট্রেশন আবেদন/প্রক্রিয়াধীন)।'),
        ...
        lbl('To request any usage license, email the address in section 16 with the specific data/asset and intended use. Unauthorized use will be enforced through DMCA notices and legal action under the Bangladeshi Copyright Act, 2023.', 'যেকোনো ব্যবহার লাইসেন্সের জন্য, সেকশন ১৬-এ থাকা ঠিকানায় নির্দিষ্ট ডেটা/অ্যাসেট ও উদ্দেশ্য জানিয়ে ইমেইল করুন। অননুমোদিত ব্যবহার DMCA নোটিশ ও বাংলাদেশ কপিরাইট আইন ২০২৩-এর অধীনে আইনি ব্যবস্থা নেওয়া হবে।'),
      ],
    },
    {
      h: lbl('6a. Security & responsible disclosure', '৬ক. নিরাপত্তা ও দায়িত্বশীল প্রকাশ'),
      body: lbl('Unauthorized hacking or attack attempts against KoyJabo, its infrastructure, partners, or users are STRICTLY PROHIBITED and may constitute criminal offenses under the Bangladesh Cyber Security Act, 2026 (successor to the Digital Security Act, 2018), as well as international computer-misuse statutes.', 'কই যাবো, এর অবকাঠামো, অংশীদার, বা ব্যবহারকারীদের বিরুদ্ধে অননুমোদিত হ্যাকিং বা আক্রমণ চেষ্টা কঠোরভাবে নিষিদ্ধ এবং বাংলাদেশ সাইবার নিরাপত্তা আইন ২০২৬ (ডিজিটাল নিরাপত্তা আইন ২০১৮-এর উত্তরসূরি) এবং আন্তর্জাতিক কম্পিউটার-অপব্যবহার আইনের অধীনে অপরাধ হতে পারে।'),
      bullets: [
