        ...
        <div style={{
          ...
          <div style={{ flex: 1, position: 'relative', minWidth: 0 }}>
            ...
            {authUser?.provider === 'google' && (
              <div style={{ display:'inline-flex',alignItems:'center',gap:6,marginTop:6,background:'#4285F418',border:'1px solid #4285F433',borderRadius:20,padding:'3px 10px' }}>
                ...
                <span style={{ fontFamily:SANS,fontSize:11,fontWeight:700,color:'#4285F4' }}>{lbl('Signed in with Google','Google দিয়ে সাইন ইন')}</span>
              </div>
            )}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={card}>
              {[
                ...
                { label: authUser?.provider === 'google' && !authUser?.hasPassword ? lbl('Set password', 'পাসওয়ার্ড সেট করুন') : lbl('Password & security', 'পাসওয়ার্ড ও নিরাপত্তা'), route: 'password', icon: '🔐' },
